...
// declare const global: any; // Unable to find where global is defined. See https://github.com/ReactiveX/rxjs/tree/master/spec/helpers
// // 5.spec.ts wont work; but u can still take pointers from it.
...
//     console.log ('tried to use hot() in async test'); // for now. MYJS
//   }
...
//     console.log ('tried to use cold() in async test'); // for now. MYJS
//   }
...
//     console.log('tried to use expectObservable() in async test');
//   }
...
//     console.log('tried to use expectSubscriptions() in async test');
//   }
...
//     console.log('tried to use time() in async test');
//   }
